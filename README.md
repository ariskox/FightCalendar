...
- `GITHUB_MODELS_TOKEN` (preferred) or `GITHUB_TOKEN`: Token with `models:read`

Optional environment variables:

- `GITHUB_MODELS_MODEL`: Model ID (default: `openai/gpt-4.1-mini`)
- `GITHUB_MODELS_ENDPOINT`: Endpoint (default: `https://models.github.ai/inference/chat/completions`)
